...
# ─────────────────────────────────────────────
st.set_page_config(
    page_title="고유가 피해지원금 뉴스 기사 모니터링(최신 200건)",
    page_icon="📰",
    layout="wide",
)
...
NEGATIVE_KEYWORDS = [
    # 운영·서비스 관련
    "불편", "신청 장애", "서비스 장애", "시스템 장애", "홈페이지 장애", "창구 장애", "오류", "지연", "차질", "혼란", "혼선", "실패", "마비",
    "누락", "민원", "항의", "비판", "논란", "문제점", "지적", "카드깡", "상품권 깡", "역차별", "불법 거래", "차별 논란", "가짜 정보",
    # 보안·피싱·개인정보 관련 (대폭 확장)
    "개인정보", "유출", "노출", "누설", "도용", "사기",
    "특별 단속", "특별단속", "위반", "불법 행위", "불법행위",
    "해킹", "악성코드", "악성 코드", "악성앱", "악성 앱", "미끼문자",
    "피싱", "보이스피싱", "보이스 피싱",
    "스미싱", "랜섬웨어", "큐싱", "파밍",
